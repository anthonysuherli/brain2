# br8n — Logo Design Instruction (for Claude)

> Paste this whole file to Claude (or any design-capable model/designer) and say:
> **"Generate logo ideas for br8n following this brief."**
...
**br8n** is a context-capture and resume engine for developers. It captures a
...
One-line essence: **br8n remembers where you were so you don't have to rebuild it.**
...
For each, give: a name, the core metaphor, why it fits br8n, and an SVG sketch.
...
- **Wordmark:** lowercase `br8n` reads friendlier and more dev-native than
  `Br8n`. The `2` may be a subscript-style or same-baseline. Propose a geometric
...
3. For your **#1 pick**, also render: the **lockup** (symbol + `br8n` wordmark,
