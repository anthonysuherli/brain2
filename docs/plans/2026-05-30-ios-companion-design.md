# brain2 iOS companion — v1 design

**Date:** 2026-05-30
**Status:** approved (brainstorm), implementation starting
**Scope:** first standalone consumer-facing UI for brain2 — a native iOS app
...
```
SwiftUI app  ──HTTPS + Bearer JWT──>  hosted brain2 cloud API (FastAPI)  ──>  Supabase
...
domain, e.g. `api.brain2.dev`. Avoid Vercel here — serverless/short-lived means a
