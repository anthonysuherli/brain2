# br8n statusline — resume-cue redesign
...
|---|---|---|
| NO_CAPTURE | No snapshot exists for this branch | `⚡ no capture yet · /br8n:capture to anchor` |
...
Two signals, both derived from data br8n already stores:
...
| State | Action hint |
|---|---|
| NO_CAPTURE | `/br8n:capture to anchor` |
...
Old portfolio renderer preserved behind `BR8N_STATUSLINE=portfolio` env flag
for one version, then removed.

## Files touched

- `scripts/br8n-statusline.py` — main rewrite
