...
These migrations define the Postgres + pgvector schema for br8n's **cloud
tier** (`SupabaseStore`). They originated alongside the Delapan engine and were
copied into br8n as part of the self-contained fork.

**br8n's copy of this schema is licensed under br8n's [MIT License](../LICENSE).**
The author (Anthony Suherli) owns both br8n and Delapan and re-licenses this
...
cross-repo dependency or symlink — br8n stays standalone, and br8n owns
...
`backend/br8n/store/`). These SQL files are only for the Supabase-backed cloud
tier.
