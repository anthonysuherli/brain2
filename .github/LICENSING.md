...
brain2 ships under the **MIT License** — fully permissive, OSI-approved "open source."
...
brain2 is a developer tool (a Claude Code plugin: cross-repo activity/session knowledge
...
> **Portfolio note:** keeping brain2 genuinely MIT gives you a real OSI-approved
...
| Actor | Allowed? |
|---|---|
| Use brain2 for anything, including commercially | ✅ |
| Fork, modify, redistribute (open or closed source) | ✅ |
| Submit a PR | ✅ |
| Remove the copyright notice | ❌ (the one MIT obligation) |
| Use the name "brain2" for their own product | ❌ (trademark, not granted by MIT) |
...
```bash
# adjust per brain2's actual stack (backend/ + ios-app/ + site/)
...
- [x] Assert trademark on "brain2" — see [TRADEMARKS.md](TRADEMARKS.md) + README footer.
...
and update the README section. No other change. Do this only if brain2 grows enough that
