...
Thanks for your interest in br8n. Contributions are welcome under the terms
...
br8n is licensed under the [MIT License](../LICENSE). **By submitting a
...
br8n uses the [Developer Certificate of Origin](DCO) (DCO 1.1) instead of a
...
3. Match the surrounding code's style (see `CLAUDE.md` for conventions; imports
   are always `from br8n.*`, never `from delapan.*`).
