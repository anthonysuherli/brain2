...
the subject line `br8n security`. If you use GitHub's private vulnerability
...
- **Captured context may contain secrets.** br8n snapshots workspace state
  (git diffs, open files, hypotheses). If you find br8n transmitting or
