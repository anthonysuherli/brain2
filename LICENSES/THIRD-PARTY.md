# Third-Party Licenses — brain2 backend

> Generated inventory of the Python dependencies brain2's backend resolves into.
> brain2 itself is [MIT](../LICENSE); this file documents that its dependency
...
on them. brain2 consumes these packages unmodified, so no copyleft obligation is
triggered, and brain2 may ship under MIT without restriction. (`orjson` and
