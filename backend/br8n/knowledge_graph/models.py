...
Ported from delapan's KG models (the only piece of that layer br8n reuses).
...
class KGSchema(BaseModel):
    ...
    # (Delapan uses dict[relation_name, list[str]]; br8n uses a flat list
...
class KGNode(BaseModel):
    ...
    label: str = Field(
        description="Canonical name of the entity (e.g. 'br8n' or 'store/base.py')"
    )
