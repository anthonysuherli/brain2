...
2. LLM calls route through br8n's AI Gateway client (dotted model slugs:
...
from br8n.knowledge_graph.models import (
    _ATTR_TYPES,
    Attribute,
    KGSchema,
    NodeType,
...
def _fallback_schema(emergent: dict | None) -> KGSchema:
    ...
    br8n's default activity-graph classes. Never raises; gives the user something to edit."""
