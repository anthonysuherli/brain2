...
from br8n.knowledge_graph.drift import assess_drift, residual_breakdown
from br8n.knowledge_graph.models import KGSchema, NodeType
...
def test_cold_start_offers_when_enough_and_not_yet_offered():
    ...
    assert v.offer_line and "/br8n:schema" in v.offer_line
